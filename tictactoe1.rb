...
def user_move
  ...
  case move
    ...
    @game_board_boxes[:box1] = "X" if @game_board_boxes[:box1] == " "
    when "2"
    invalid_user_input if @game_board_boxes[:box2] != " "
    @game_board_boxes[:box2] = "X" if @game_board_boxes[:box2] == " "
    when "3"
    invalid_user_input if @game_board_boxes[:box3] != " "
    @game_board_boxes[:box3] = "X" if @game_board_boxes[:box3] == " "
    when "4"
    invalid_user_input if @game_board_boxes[:box4] != " "
    @game_board_boxes[:box4] = "X" if @game_board_boxes[:box4] == " "
    when "5"
    invalid_user_input if @game_board_boxes[:box5] != " "
    @game_board_boxes[:box5] = "X" if @game_board_boxes[:box5] == " "
    when "6"
    invalid_user_input if @game_board_boxes[:box6] != " "
    @game_board_boxes[:box6] = "X" if @game_board_boxes[:box6] == " "
    when "7"
    invalid_user_input if @game_board_boxes[:box7] != " "
    @game_board_boxes[:box7] = "X" if @game_board_boxes[:box7] == " "
    when "8"
    invalid_user_input if @game_board_boxes[:box8] != " "
    @game_board_boxes[:box8] = "X" if @game_board_boxes[:box8] == " "
    when "9"
    invalid_user_input if @game_board_boxes[:box9] != " "
    @game_board_boxes[:box9] = "X" if @game_board_boxes[:box9] == " "
  else
    invalid_user_input
  end
end
